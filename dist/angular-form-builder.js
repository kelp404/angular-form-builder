                ...
                link: function(scope, element) {
                    ...
                    scope.popover = {
                        ...
                        modal: function($event) {
                           ...
                           */
                            ...
                            $builder.modalFormObject(scope.$parent.formName, scope.$parent.$index);
                            //$event.preventDefault();
                            $builder.modalFormObject(scope.$parent.formName, scope.$parent.$index);
                            // $(element).popover('hide');
                        },
                    ...
                    $(element).on('show.bs.popover', function() {
                        ...
                        if ($popover.length > 0) {
                            ...
                            setTimeout(function() {
                                $popover.addClass('in');
                                $(element).removeClass('active');//@kim
...
(function() {
    ...
    angular.module('builder.provider', []).provider('$builder', function() {
       ...
       * @KIM-TBE
       * */
        this.modalFormObject = (function(_this) {
            return function(name, index, formObject, component, forms) {
              ...
              /*
               ...
               @param index: The form object index.
               */
                var fieldEditFormObjectCallback;
                fieldEditFormObjectCallback = function() {
                    ...
                    // _this.addFormObject(name, 1, 2100);
                    //  _this.updateFormObjectIndex(name, 1, 2100);

                    return _this.reindexFormObject(name);
                  /**/

                };
                return $rootScope.$broadcast('fieldEditTrigger', {
                    callback: fieldEditFormObjectCallback
                });
            };
        })(this);
            ...
            '$injector', (function(_this) {
                return function($injector) {
                    ...
                    return {
                        ...
                        modalFormObject: _this.modalFormObject,
