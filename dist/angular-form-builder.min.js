...
k.mode?c&&("mirror"===k.mode&&f.insertFormObject(b,$(d).find(".empty").index(".fb-form-object-editable"),{component:k.object.componentName}),"drag"===k.mode&&(c=k.object.formObject.index,a=$(d).find(".empty").index(".fb-form-object-editable"),c<a&&a--,f.updateFormObjectIndex(b,c,a))):(a=k.object.formObject,f.removeFormObject(e.fbBuilder,a.index)),$(d).find(".empty").remove();$(d).find(".empty").remove()}})}}};b.$inject=["$injector"];l.directive("fbBuilder",b);b=function(c){return{restrict:"A",link:function(a,
d,e){var f,b,h,m,k,n,r,p,q;h=c.get("$builder");k=c.get("$drag");n=c.get("$parse");m=c.get("$compile");r=c.get("$validator");p=n(e.fbFormObjectEditable)(a);e=h.components[p.component];for(b in p)n=p[b],"$$hashKey"!==b&&(a[b]=n);a.optionsText=p.options.join("\n");a.$watch("[label, description, placeholder, required, options]",function(){p.label=a.label;p.description=a.description;p.placeholder=a.placeholder;p.required=a.required;return p.options=a.options},!0);a.$watch("optionsText",function(c){var d,
e,b,f;b=c.split("\n");f=[];d=0;for(e=b.length;d<e;d++)c=b[d],0<c.length&&f.push(c);a.options=f;return a.inputText=a.options[0]});k.draggable($(d),{object:{formObject:p}});b=$(e.template);b=m(b)(a);$(d).append(b);$(d).on("click",function(){return!1});q="fb-"+Math.random().toString().substr(2);f=!1;b=null;b=e.popoverTemplate;b=$(b).addClass(q);a.popover={ngModel:null,save:function(c){c.preventDefault();r.validate(a).success(function(){f=!0;return $(d).popover("hide")})},remove:function(c){c.preventDefault();
c=$(d).closest("[fb-builder]").attr("fb-builder");h.removeFormObject(c,a.$index);$(d).popover("hide")},shown:function(){this.ngModel={label:a.label,description:a.description,placeholder:a.placeholder,required:a.required,optionsText:a.optionsText};return f=!1},cancel:function(c){this.ngModel&&(a.label=this.ngModel.label,a.description=this.ngModel.description,a.placeholder=this.ngModel.placeholder,a.required=this.ngModel.required,a.optionsText=this.ngModel.optionsText);c&&(c.preventDefault(),$(d).popover("hide"))}};
b=m(b)(a);$(d).addClass(q);$(d).popover({html:!0,title:e.label,content:b,container:"body"});$(d).on("show.bs.popover",function(){var a,c;if(k.isMouseMoved())return!1;$("div.fb-form-object-editable:not(."+q+")").popover("hide");a=$("form."+q).closest(".popover");if(0<a.length)return c=$(d).offset().top+$(d).height()/2,c-=a.height()/2,a.css({position:"absolute",top:c}),a.show(),setTimeout(function(){a.addClass("in");return $(d).triggerHandler("shown.bs.popover")},0),!1});$(d).on("shown.bs.popover",
function(){$(".popover ."+q+" input:first").select();a.$apply(function(){return a.popover.shown()})});return $(d).on("hide.bs.popover",function(){var c;c=$("form."+q).closest(".popover");f||(a.$$phase?a.popover.cancel():a.$apply(function(){return a.popover.cancel()}));c.removeClass("in");setTimeout(function(){return c.hide()},300);return!1})}}};b.$inject=["$injector"];l.directive("fbFormObjectEditable",b);l.directive("fbComponents",function(){return{restrict:"A",template:'<ul ng-if="groups.length > 1" class="nav nav-tabs nav-justified">\n    <li ng-repeat="group in groups" ng-class="{active:activeGroup==group}">\n        <a href=\'#\' ng-click="selectGroup($event, group)">{{group}}</a>\n    </li>\n</ul>\n<div class=\'form-horizontal\'>\n    <div class=\'fb-component\' ng-repeat="component in components"\n        fb-component="component"></div>\n</div>',
...
controller:"fbFormController",link:function(a,d,b){var f,g;f=c.get("$builder");g=c.get("$timeout");a.form=f.forms[b.fbForm];return a.$watch("form",function(){a.input.length>a.form.length&&a.input.splice(a.form.length);return g(function(){return a.$broadcast(f.broadcastChannel.updateInput)})},!0)}}};b.$inject=["$injector"];l.directive("fbForm",b);b=function(c){return{restrict:"A",link:function(a,d,b){var f,g,h,m,k,n;f=c.get("$builder");g=c.get("$compile");k=c.get("$parse")(b.fbFormObject)(a);h=f.components[k.component];
n=function(c){return a.$parent.input.splice(a.$index,1,{id:k.id,label:k.label,value:null!=c?c:""})};m=function(){var c,d,b;b=[];for(c in k)d=k[c],"$$hashKey"!==c&&b.push(a[c]=d);return b};a.$on(f.broadcastChannel.updateInput,function(){return n(a.inputText)});h.arrayToText&&(a.inputArray=[],a.$watch("inputArray",function(c,d){var b,e;if(c!==d){b=[];for(e in a.inputArray)a.inputArray[e]&&b.push(a.options[e]);return a.inputText=b.join(", ")}},!0));a.$watch("inputText",function(){return n(a.inputText)});
a.$watch(b.fbFormObject,function(){return m()},!0);b=$(h.template);b.find("[ng-model='inputText']").attr({validator:"{{validation}}","validator-error":"{{errorMessage}}"});g=g(b)(a);$(d).append(g);if(!h.arrayToText&&0<k.options.length)return a.inputText=k.options[0]}}};b.$inject=["$injector"];l.directive("fbFormObject",b)}).call(this);
...
(function(){var l=[].indexOf||function(b){for(var c=0,a=this.length;c<a;c++)if(c in this&&this[c]===b)return c;return-1};angular.module("builder.provider",[]).provider("$builder",function(){var b=this;this.components={};this.groups=[];this.broadcastChannel={updateInput:"$updateInput"};this.forms={"default":[]};this.formsId={"default":0};this.setupProviders=function(b){return b};this.convertComponent=function(b,a){var d,e,f,g,h,m,k,l,r,p;d={name:b,group:null!=(e=a.group)?e:"Default",label:null!=(f=
a.label)?f:"",description:null!=(g=a.description)?g:"",placeholder:null!=(h=a.placeholder)?h:"",required:null!=(m=a.required)?m:!1,validation:null!=(k=a.validation)?k:"/.*/",errorMessage:null!=(l=a.errorMessage)?l:"",options:null!=(r=a.options)?r:[],arrayToText:null!=(p=a.arrayToText)?p:!1,template:a.template,popoverTemplate:a.popoverTemplate};d.template||console.error("template is empty");d.popoverTemplate||console.error("popoverTemplate is empty");return d};this.convertFormObject=function(b,a){var d,
e,f,g,h,l,k,n,r,p,q,s,t,u,v,w;null==a&&(a={});d=this.components[a.component];null==d&&console.error("component "+a.component+" was not registered.");if(a.id){e=!1;l=this.forms[b];g=0;for(h=l.length;g<h;g++)if(f=l[g],a.id<=f.id){a.id=this.formsId[b]++;e=!0;break}e||(this.formsId[b]=a.id+1)}return{id:null!=(k=a.id)?k:this.formsId[b]++,component:a.component,draggable:null!=(r=a.draggable)?r:!0,index:null!=(p=a.index)?p:0,label:null!=(q=a.label)?q:d.label,description:null!=(s=a.description)?s:d.description,
placeholder:null!=(t=a.placeholder)?t:d.placeholder,options:null!=(u=a.options)?u:d.options,required:null!=(v=a.required)?v:d.required,validation:null!=(w=a.validation)?w:d.validation,errorMessage:null!=(n=a.errorMessage)?n:d.errorMessage}};this.reIndexFormObject=function(c){var a,d,e;c=b.forms[c];a=d=0;for(e=c.length-1;d<=e;a=d+=1)c[a].index=a};this.registerComponent=function(c,a){var d,e;null==a&&(a={});null==b.components[c]?(d=b.convertComponent(c,a),b.components[c]=d,(e=d.group,0>l.call(b.groups,
e))&&b.groups.push(d.group)):console.error("The component "+c+" was registered.")};this.addFormObject=function(c,a){var d,e;null==a&&(a={});null==(d=b.forms)[c]&&(d[c]=[]);null==(e=b.formsId)[c]&&(e[c]=0);return b.insertFormObject(c,b.forms[c].length,a)};this.insertFormObject=function(c,a,d){var e,f;null==d&&(d={});null==(e=b.forms)[c]&&(e[c]=[]);null==(f=b.formsId)[c]&&(f[c]=0);a>b.forms.length?a=b.forms.length:0>a&&(a=0);b.forms[c].splice(a,0,b.convertFormObject(c,d));return b.reIndexFormObject(c)};
this.removeFormObject=function(c,a){b.forms[c].splice(a,1);return b.reIndexFormObject(c)};this.updateFormObjectIndex=function(c,a,d){var e;if(a!==d)return e=b.forms[c],a=e.splice(a,1)[0],e.splice(d,0,a),b.reIndexFormObject(c)};this.get=function(b){this.setupProviders(b);return{components:this.components,groups:this.groups,forms:this.forms,broadcastChannel:this.broadcastChannel,registerComponent:this.registerComponent,addFormObject:this.addFormObject,insertFormObject:this.insertFormObject,removeFormObject:this.removeFormObject,
