...
link:function(a,c,f){a.formObject=b(f.fbFormObject)(a);a.$component=d.components[a.formObject.component];a.$on(d.broadcastChannel.updateInput,function(){return a.updateInput(a.inputText)});a.$component.arrayToText&&(a.inputArray=[],a.$watch("inputArray",function(c,b){var f,d,e;if(c!==b){f=[];for(d in a.inputArray)a.inputArray[d]&&f.push(null!=(e=a.options[d])?e:a.inputArray[d]);return a.inputText=f.join(", ")}},!0));a.$watch("inputText",function(){return a.updateInput(a.inputText)});a.$watch(f.fbFormObject,
...
(function(){var g=[].indexOf||function(d){for(var e=0,b=this.length;e<b;e++)if(e in this&&this[e]===d)return e;return-1};angular.module("builder.provider",[]).provider("$builder",function(){var d,e,b;b=d=e=null;this.version="0.0.2";this.components={};this.groups=[];this.broadcastChannel={updateInput:"$updateInput"};this.forms={"default":[]};this.convertComponent=function(a,c){var b,d,e,g,r,l,m,s,n,q,t;b={name:a,group:null!=(d=c.group)?d:"Default",label:null!=(e=c.label)?e:"",description:null!=(g=
c.description)?g:"",placeholder:null!=(r=c.placeholder)?r:"",editable:null!=(l=c.editable)?l:!0,required:null!=(m=c.required)?m:!1,validation:null!=(s=c.validation)?s:"/.*/",validationOptions:null!=(n=c.validationOptions)?n:[],options:null!=(q=c.options)?q:[],arrayToText:null!=(t=c.arrayToText)?t:!1,template:c.template,templateUrl:c.templateUrl,popoverTemplate:c.popoverTemplate,popoverTemplateUrl:c.popoverTemplateUrl};b.template||b.templateUrl||console.error("The template is empty.");b.popoverTemplate||
b.popoverTemplateUrl||console.error("The popoverTemplate is empty.");return b};this.convertFormObject=function(a,c){var b,d,e,g,r,l,m,s,n;null==c&&(c={});b=this.components[c.component];if(null==b)throw"The component "+c.component+" was not registered.";return{id:c.id,component:c.component,editable:null!=(d=c.editable)?d:b.editable,index:null!=(e=c.index)?e:0,label:null!=(g=c.label)?g:b.label,description:null!=(r=c.description)?r:b.description,placeholder:null!=(l=c.placeholder)?l:b.placeholder,options:null!=
(m=c.options)?m:b.options,required:null!=(s=c.required)?s:b.required,validation:null!=(n=c.validation)?n:b.validation}};this.reindexFormObject=function(a){return function(c){var b,d,e;c=a.forms[c];b=d=0;for(e=c.length;d<e;b=d+=1)c[b].index=b}}(this);this.setupProviders=function(a){return function(a){e=a;d=e.get("$http");return b=e.get("$templateCache")}}(this);this.loadTemplate=function(a){null==a.template&&d.get(a.templateUrl,{cache:b}).success(function(c){return a.template=c});if(null==a.popoverTemplate)return d.get(a.popoverTemplateUrl,
{cache:b}).success(function(c){return a.popoverTemplate=c})};this.registerComponent=function(a){return function(c,b){var d,k;null==b&&(b={});null==a.components[c]?(d=a.convertComponent(c,b),a.components[c]=d,null!=e&&a.loadTemplate(d),(k=d.group,0>g.call(a.groups,k))&&a.groups.push(d.group)):console.error("The component "+c+" was registered.")}}(this);this.addFormObject=function(a){return function(c,b){var d;null==b&&(b={});null==(d=a.forms)[c]&&(d[c]=[]);return a.insertFormObject(c,a.forms[c].length,
b)}}(this);this.insertFormObject=function(a){return function(c,b,d){var e;null==d&&(d={});null==(e=a.forms)[c]&&(e[c]=[]);b>a.forms[c].length?b=a.forms[c].length:0>b&&(b=0);a.forms[c].splice(b,0,a.convertFormObject(c,d));a.reindexFormObject(c);return a.forms[c][b]}}(this);this.removeFormObject=function(a){return function(b,d){a.forms[b].splice(d,1);return a.reindexFormObject(b)}}(this);this.updateFormObjectIndex=function(a){return function(b,d,e){var g;if(d!==e)return g=a.forms[b],d=g.splice(d,1)[0],
g.splice(e,0,d),a.reindexFormObject(b)}}(this);this.$get=["$injector",function(a){return function(b){var d,e;a.setupProviders(b);e=a.components;for(d in e)b=e[d],a.loadTemplate(b);return{version:a.version,components:a.components,groups:a.groups,forms:a.forms,broadcastChannel:a.broadcastChannel,registerComponent:a.registerComponent,addFormObject:a.addFormObject,insertFormObject:a.insertFormObject,removeFormObject:a.removeFormObject,updateFormObjectIndex:a.updateFormObjectIndex}}}(this)]})}).call(this);
