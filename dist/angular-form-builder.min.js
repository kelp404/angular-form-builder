...
c=c(e)(a);$(d).append(c);if(!g.arrayToText&&0<a.formObject.options.length)return a.inputText=a.formObject.options[0]}}};c.$inject=["$injector"];l.directive("fbFormObject",c)}).call(this);
...
(function(){var l=[].indexOf||function(c){for(var b=0,a=this.length;b<a;b++)if(b in this&&this[b]===c)return b;return-1};angular.module("builder.provider",[]).provider("$builder",function(){var c=this;this.version="0.0.1";this.components={};this.groups=[];this.broadcastChannel={updateInput:"$updateInput"};this.forms={"default":[]};this.formsId={"default":0};this.convertComponent=function(b,a){var d,c,f,h,g,k,l,m,n,q,s;d={name:b,group:null!=(c=a.group)?c:"Default",label:null!=(f=a.label)?f:"",description:null!=
(h=a.description)?h:"",placeholder:null!=(g=a.placeholder)?g:"",editable:null!=(k=a.editable)?k:!0,required:null!=(l=a.required)?l:!1,validation:null!=(m=a.validation)?m:"/.*/",validationOptions:null!=(n=a.validationOptions)?n:[],options:null!=(q=a.options)?q:[],arrayToText:null!=(s=a.arrayToText)?s:!1,template:a.template,popoverTemplate:a.popoverTemplate};d.template||console.error("The template is empty.");d.popoverTemplate||console.error("The popoverTemplate is empty.");return d};this.convertFormObject=
function(b,a){var d,c,f,h,g,k,l,m,n,q,s,r,t,u,v;null==a&&(a={});d=this.components[a.component];if(null==d)throw"The component "+a.component+" was not registered.";if(a.id){c=!1;k=this.forms[b];h=0;for(g=k.length;h<g;h++)if(f=k[h],a.id<=f.id){a.id=this.formsId[b]++;c=!0;break}c||(this.formsId[b]=a.id+1)}return{id:null!=(l=a.id)?l:this.formsId[b]++,component:a.component,editable:null!=(m=a.editable)?m:d.editable,index:null!=(n=a.index)?n:0,label:null!=(q=a.label)?q:d.label,description:null!=(s=a.description)?
s:d.description,placeholder:null!=(r=a.placeholder)?r:d.placeholder,options:null!=(t=a.options)?t:d.options,required:null!=(u=a.required)?u:d.required,validation:null!=(v=a.validation)?v:d.validation}};this.reindexFormObject=function(b){var a,d,e;b=c.forms[b];a=d=0;for(e=b.length;d<e;a=d+=1)b[a].index=a};this.registerComponent=function(b,a){var d,e;null==a&&(a={});null==c.components[b]?(d=c.convertComponent(b,a),c.components[b]=d,(e=d.group,0>l.call(c.groups,e))&&c.groups.push(d.group)):console.error("The component "+
b+" was registered.")};this.addFormObject=function(b,a){var d;null==a&&(a={});null==(d=c.forms)[b]&&(d[b]=[]);return c.insertFormObject(b,c.forms[b].length,a)};this.insertFormObject=function(b,a,d){var e,f;null==d&&(d={});null==(e=c.forms)[b]&&(e[b]=[]);null==(f=c.formsId)[b]&&(f[b]=0);a>c.forms[b].length?a=c.forms[b].length:0>a&&(a=0);c.forms[b].splice(a,0,c.convertFormObject(b,d));return c.reindexFormObject(b)};this.removeFormObject=function(b,a){c.forms[b].splice(a,1);return c.reindexFormObject(b)};
this.updateFormObjectIndex=function(b,a,d){var e;if(a!==d)return e=c.forms[b],a=e.splice(a,1)[0],e.splice(d,0,a),c.reindexFormObject(b)};this.$get=this.get=function(){return{version:this.version,components:this.components,groups:this.groups,forms:this.forms,broadcastChannel:this.broadcastChannel,registerComponent:this.registerComponent,addFormObject:this.addFormObject,insertFormObject:this.insertFormObject,removeFormObject:this.removeFormObject,updateFormObjectIndex:this.updateFormObjectIndex}}})}).call(this);
