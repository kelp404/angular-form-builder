...
k,n,r,p,q;h=c.get("$builder");k=c.get("$drag");n=c.get("$parse");m=c.get("$compile");r=c.get("$validator");p=n(e.fbFormObjectEditable)(a);e=h.components[p.component];for(b in p)n=p[b],"$$hashKey"!==b&&(a[b]=n);a.optionsText=p.options.join("\n");a.$watch("[label, description, placeholder, required, options]",function(){p.label=a.label;p.description=a.description;p.placeholder=a.placeholder;p.required=a.required;return p.options=a.options},!0);a.$watch("optionsText",function(c){var d,e,b,f;b=c.split("\n");
...
h.removeFormObject(c,a.$index);$(d).popover("hide")},shown:function(){this.ngModel={label:a.label,description:a.description,placeholder:a.placeholder,required:a.required,optionsText:a.optionsText};return f=!1},cancel:function(c){this.ngModel&&(a.label=this.ngModel.label,a.description=this.ngModel.description,a.placeholder=this.ngModel.placeholder,a.required=this.ngModel.required,a.optionsText=this.ngModel.optionsText);c&&(c.preventDefault(),$(d).popover("hide"))}};b=m(b)(a);$(d).addClass(q);$(d).popover({html:!0,
title:e.label,content:b,container:"body"});$(d).on("show.bs.popover",function(){var a,c;if(k.isMouseMoved())return!1;$("div.fb-form-object-editable:not(."+q+")").popover("hide");a=$("form."+q).closest(".popover");if(0<a.length)return c=$(d).offset().top+$(d).height()/2,c-=a.height()/2,a.css({position:"absolute",top:c}),a.show(),setTimeout(function(){a.addClass("in");return $(d).triggerHandler("shown.bs.popover")},0),!1});$(d).on("shown.bs.popover",function(){$(".popover ."+q+" input:first").select();
a.$apply(function(){return a.popover.shown()})});return $(d).on("hide.bs.popover",function(){var c;c=$("form."+q).closest(".popover");f||(a.$$phase?a.popover.cancel():a.$apply(function(){return a.popover.cancel()}));c.removeClass("in");setTimeout(function(){return c.hide()},300);return!1})}}};b.$inject=["$injector"];l.directive("fbFormObjectEditable",b);l.directive("fbComponents",function(){return{restrict:"A",template:'<ul ng-if="groups.length > 1" class="nav nav-tabs nav-justified">\n    <li ng-repeat="group in groups" ng-class="{active:activeGroup==group}">\n        <a href=\'#\' ng-click="selectGroup($event, group)">{{group}}</a>\n    </li>\n</ul>\n<div class=\'form-horizontal\'>\n    <div class=\'fb-component\' ng-repeat="component in components"\n        fb-component="component"></div>\n</div>',
