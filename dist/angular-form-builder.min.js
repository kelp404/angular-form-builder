...
(function(){angular.module("builder.directive",["builder.provider","builder.controller","builder.drag","validator"]).directive("fbBuilder",["$injector",function(g){var d,e;d=g.get("$builder");e=g.get("$drag");return{restrict:"A",template:"<div class='form-horizontal'>\n    <div class='fb-form-object-editable' ng-repeat=\"object in formObjects\"\n        fb-form-object-editable=\"object\"></div>\n</div>",link:function(b,a,c){var f,h,k;b.formName=c.fbBuilder;null==(h=d.forms)[k=b.formName]&&(h[k]=[]);
b.formObjects=d.forms[b.formName];f=!0;$(a).addClass("fb-builder");return e.droppable($(a),{move:function(c){var b,h,d,k,e,g;f&&($("div.fb-form-object-editable").popover("hide"),f=!1);h=$(a).find(".fb-form-object-editable:not(.empty,.dragging)");if(0===h.length)0===$(a).find(".fb-form-object-editable.empty").length&&$(a).find(">div:first").append($("<div class='fb-form-object-editable empty'></div>"));else{k=[];k.push(-1E3);d=e=0;for(g=h.length;e<g;d=e+=1)b=$(h[d]),d=b.offset(),b=b.height(),k.push(d.top+
b/2);k.push(k[k.length-1]+1E3);d=e=1;for(g=k.length;e<g;d=e+=1)if(c.pageY>k[d-1]&&c.pageY<=k[d]){$(a).find(".empty").remove();c=$("<div class='fb-form-object-editable empty'></div>");d-1<h.length?c.insertBefore($(h[d-1])):c.insertAfter($(h[d-2]));break}}},out:function(){f&&($("div.fb-form-object-editable").popover("hide"),f=!1);return $(a).find(".empty").remove()},up:function(h,k,l){f=!0;if(e.isMouseMoved())return k||"drag"!==l.mode?k&&("mirror"===l.mode&&d.insertFormObject(b.formName,$(a).find(".empty").index(".fb-form-object-editable"),
{component:l.object.componentName}),"drag"===l.mode&&(k=l.object.formObject.index,h=$(a).find(".empty").index(".fb-form-object-editable"),k<h&&h--,d.updateFormObjectIndex(b.formName,k,h))):(h=l.object.formObject,h.editable&&d.removeFormObject(c.fbBuilder,h.index)),$(a).find(".empty").remove();$(a).find(".empty").remove()}})}}}]).directive("fbFormObjectEditable",["$injector",function(g){var d,e,b,a;d=g.get("$builder");b=g.get("$drag");e=g.get("$compile");a=g.get("$validator");return{restrict:"A",controller:"fbFormObjectEditableController",
scope:{formObject:"=fbFormObjectEditable"},link:function(c,f){var h;c.inputArray=[];c.$component=d.components[c.formObject.component];c.setupScope(c.formObject);c.$watch("$component.template",function(a){if(a)return a=e(a)(c),$(f).html(a)});$(f).on("click",function(){return!1});b.draggable($(f),{object:{formObject:c.formObject}});if(c.formObject.editable)return h={},c.$watch("$component.popoverTemplate",function(a){if(a)return $(f).removeClass(h.id),h={id:"fb-"+Math.random().toString().substr(2),
isClickedSave:!1,view:null,html:a},h.html=$(h.html).addClass(h.id),h.view=e(h.html)(c),$(f).addClass(h.id),$(f).popover({html:!0,title:c.$component.label,content:h.view,container:"body"})}),c.popover={save:function(b){b.preventDefault();a.validate(c).success(function(){h.isClickedSave=!0;return $(f).popover("hide")})},remove:function(a){a.preventDefault();d.removeFormObject(c.$parent.formName,c.$index);$(f).popover("hide")},shown:function(){c.data.backup();return h.isClickedSave=!1},cancel:function(a){c.data.rollback();
a&&(a.preventDefault(),$(f).popover("hide"))}},$(f).on("show.bs.popover",function(){var a,c;if(b.isMouseMoved())return!1;$("div.fb-form-object-editable:not(."+h.id+")").popover("hide");a=$("form."+h.id).closest(".popover");if(0<a.length)return c=$(f).offset().top+$(f).height()/2,c-=a.height()/2,a.css({position:"absolute",top:c}),a.show(),setTimeout(function(){a.addClass("in");return $(f).triggerHandler("shown.bs.popover")},0),!1}),$(f).on("shown.bs.popover",function(){$(".popover ."+h.id+" input:first").select();
c.$apply(function(){return c.popover.shown()})}),$(f).on("hide.bs.popover",function(){var a;a=$("form."+h.id).closest(".popover");h.isClickedSave||(c.$$phase||c.$root.$$phase?c.popover.cancel():c.$apply(function(){return c.popover.cancel()}));a.removeClass("in");setTimeout(function(){return a.hide()},300);return!1})}}}]).directive("fbComponents",function(){return{restrict:"A",template:'<ul ng-if="groups.length > 1" class="nav nav-tabs nav-justified">\n    <li ng-repeat="group in groups" ng-class="{active:activeGroup==group}">\n        <a href=\'#\' ng-click="selectGroup($event, group)">{{group}}</a>\n    </li>\n</ul>\n<div class=\'form-horizontal\'>\n    <div class=\'fb-component\' ng-repeat="component in components"\n        fb-component="component"></div>\n</div>',
