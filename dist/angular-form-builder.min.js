...
g.forms[k];c=!0;$(e).addClass("fb-builder");return f.droppable($(e),{move:function(a,f){var d,b,g,k,l,h;c&&($("div.fb-form-object-editable").popover("hide"),c=!1);g=$(e).find(".fb-form-object-editable:not(.empty,.dragging)");if(0===g.length)0===$(e).find(".fb-form-object-editable.empty").length&&$(e).find(">div:first").append($("<div class='fb-form-object-editable empty'></div>"));else{d=[];d.push(-1E3);d.push($(g[0]).offset().top+$(g[0]).height()/2);k=l=0;for(h=g.length-1;l<=h;k=l+=1)0!==k&&(b=$(g[k]),
k=b.offset(),b=b.height(),d.push(k.top+b/2));d.push(d[d.length-1]+1E3);k=l=0;for(h=d.length-1;l<=h;k=l+=1)if(0!==k&&a.pageY>d[k-1]&&a.pageY<=d[k]){$(e).find(".empty").remove();d=$("<div class='fb-form-object-editable empty'></div>");k-1<g.length?d.insertBefore($(g[k-1])):d.insertAfter($(g[k-2]));break}}},out:function(a,d){c&&($("div.fb-form-object-editable").popover("hide"),c=!1);return $(e).find(".empty").remove()},up:function(a,b,l){c=!0;if(f.isMouseMoved())return b||"drag"!==l.mode?b&&("mirror"===
l.mode&&g.insertFormObject(k,$(e).find(".empty").index(".fb-form-object-editable"),{component:l.object.componentName}),"drag"===l.mode&&(b=l.object.formObject.index,a=$(e).find(".empty").index(".fb-form-object-editable"),b<a&&a--,g.updateFormObjectIndex(k,b,a))):(a=l.object.formObject,g.removeFormObject(d.fbBuilder,a.index)),$(e).find(".empty").remove();$(e).find(".empty").remove()}})}}};c.$inject=["$injector"];h.directive("fbBuilder",c);c=function(b){return{restrict:"A",link:function(a,e,d){var g,
f,c,k,l,m,p,n,q;c=b.get("$builder");l=b.get("$drag");m=b.get("$parse");k=b.get("$compile");p=b.get("$validator");n=m(d.fbFormObjectEditable)(a);d=c.components[n.component];for(f in n)m=n[f],"$$hashKey"!==f&&(a[f]=m);a.optionsText=n.options.join("\n");a.$watch("[label, description, placeholder, required, options]",function(){n.label=a.label;n.description=a.description;n.placeholder=a.placeholder;n.required=a.required;return n.options=a.options},!0);a.$watch("optionsText",function(e){var d,b,f,g;f=
e.split("\n");g=[];d=0;for(b=f.length;d<b;d++)e=f[d],0<e.length&&g.push(e);a.options=g;return a.inputText=a.options[0]});f=$(d.template);f=k(f)(a);$(e).append(f);$(e).on("click",function(){return!1});if(n.editable)return l.draggable($(e),{object:{formObject:n}}),q="fb-"+Math.random().toString().substr(2),g=!1,f=null,f=d.popoverTemplate,f=$(f).addClass(q),a.popover={ngModel:null,save:function(d){d.preventDefault();p.validate(a).success(function(){g=!0;return $(e).popover("hide")})},remove:function(d){d.preventDefault();
...
function(){$(".popover ."+q+" input:first").select();a.$apply(function(){return a.popover.shown()})}),$(e).on("hide.bs.popover",function(){var e;e=$("form."+q).closest(".popover");g||(a.$$phase?a.popover.cancel():a.$apply(function(){return a.popover.cancel()}));e.removeClass("in");setTimeout(function(){return e.hide()},300);return!1})}}};c.$inject=["$injector"];h.directive("fbFormObjectEditable",c);h.directive("fbComponents",function(){return{restrict:"A",template:'<ul ng-if="groups.length > 1" class="nav nav-tabs nav-justified">\n    <li ng-repeat="group in groups" ng-class="{active:activeGroup==group}">\n        <a href=\'#\' ng-click="selectGroup($event, group)">{{group}}</a>\n    </li>\n</ul>\n<div class=\'form-horizontal\'>\n    <div class=\'fb-component\' ng-repeat="component in components"\n        fb-component="component"></div>\n</div>',
...
a),c.components[b]=e,(d=e.group,0>h.call(c.groups,d))&&c.groups.push(e.group)):console.error("The component "+b+" was registered.")};this.addFormObject=function(b,a){var e,d;null==a&&(a={});null==(e=c.forms)[b]&&(e[b]=[]);null==(d=c.formsId)[b]&&(d[b]=0);return c.insertFormObject(b,c.forms[b].length,a)};this.insertFormObject=function(b,a,e){var d,g;null==e&&(e={});null==(d=c.forms)[b]&&(d[b]=[]);null==(g=c.formsId)[b]&&(g[b]=0);a>c.forms.length?a=c.forms.length:0>a&&(a=0);c.forms[b].splice(a,0,c.convertFormObject(b,
e));return c.reIndexFormObject(b)};this.removeFormObject=function(b,a){c.forms[b].splice(a,1);return c.reIndexFormObject(b)};this.updateFormObjectIndex=function(b,a,e){var d;if(a!==e)return d=c.forms[b],a=d.splice(a,1)[0],d.splice(e,0,a),c.reIndexFormObject(b)};this.get=function(b){this.setupProviders(b);return{components:this.components,groups:this.groups,forms:this.forms,broadcastChannel:this.broadcastChannel,registerComponent:this.registerComponent,addFormObject:this.addFormObject,insertFormObject:this.insertFormObject,
